...
export async function sendTrainingRequestWithoutRetry(form: FormData, password: string, traningType: "baseline-model" | "proposed-model" = "proposed-model"): Promise<Response> {
